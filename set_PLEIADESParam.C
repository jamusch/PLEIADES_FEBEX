...
void set_PLEIADESParam()
{
    ...
    //param0->fSlowMotion = kTRUE; // stop go4 analysis after each event if
  ...
  //  param0->fBoardID[0][1][4] = 0x14;
    ...
    param0->fnSideMap[s1name] = 0x130;      // slot 1 n-side goes to card 4, ch 0
    //----- Slot 2 -----
//    TString s2name = "slot2_DSSD_C161054";
    ...
    param0->fDSSDMap[s2name][0] = 0x138;            // pin1 goes to card 4, ch 8
    param0->fDSSDMap[s2name][1] = 0x139;            // pin2 goes to card 4, ch 9
    param0->fDSSDMap[s2name][2] = 0x13A;            // pin6 goes to card 4, ch 10
    param0->fDSSDMap[s2name][3] = 0x13B;            // pin7 goes to card 4, ch 11
    //----- Slot 3 -----
    ...
    param0->fnSideMap[s3name] = 0x131;      // slot 3 n-side goes to card 4, ch 1
    //----- Slot 4 -----
    ...
    param0->fnSideMap[s4name] = 0x132;      // slot 4 n-side goes to card 4, ch 2
    //----- Slot 5 -----
    ...
    param0->fnSideMap[s5name] = 0x133;      // slot 5 n-side goes to card 4, ch 3
    //----- Slot 6 -----
    ...
    param0->fnSideMap[s6name] = 0x134;      // slot 6 n-side goes to card 4, ch 4
    //----- Slot 7 -----
    /* EMPTY SLOT!!!    TString s7name = "slot7_EMPTY";
    ...
    param0->fnSideMap[s7name] = 0x135;      // slot 7 n-side goes to card 4, ch 5    */
    //----- Slot 8 -----
    ...
    param0->fpSideMap[s8name] = 0x128;      // slot 8 p-side goes to card 3, ch 8-15
    param0->fnSideMap[s8name] = 0x136;      // slot 8 n-side goes to card 4, ch 6 
    //----- Slot 9 -----
    ...
    param0->fnSideMap[s9name] = 0x137;      // slot 9 n-side goes to card 4, ch 7    */
    //----- Slot BP -----
    ...
    param0->fCrystalMap[sBPname][0] = 0x13E;         // BP pin1 goes to card 4, ch 12
    param0->fCrystalMap[sBPname][1] = 0x13F;         // BP pin2 goes to card 4, ch 13
    ...
    // Detector number 2 ---> kinpex 1
     ...
     param0->fpSideMap[s1name2] = 0x00;      // slot 1 p-side goes to card 0, ch 0-6
     param0->fnSideMap[s1name2] = 0x30;      // slot 1 n-side goes to card 3, ch 0
     //----- Slot 2 -----
     ...
     // for DSSD, make sure p-sides (ie L/R) go to pos 0/1 in fDSSDMap
     param0->fDSSDMap[s2name2][0] = 0x38;            // pin1 goes to card 3, ch 8
     param0->fDSSDMap[s2name2][1] = 0x39;            // pin2 goes to card 3, ch 9
     param0->fDSSDMap[s2name2][2] = 0x3A;            // pin6 goes to card 3, ch 10
     param0->fDSSDMap[s2name2][3] = 0x3B;            // pin7 goes to card 3, ch 11
     //----- Slot 3 -----
     ...
     param0->fpSideMap[s3name2] = 0x08;      // slot 3 p-side goes to card 0, ch 8-15
     param0->fnSideMap[s3name2] = 0x31;      // slot 3 n-side goes to card 3, ch 1
     //----- Slot 4 -----
     ...
     param0->fpSideMap[s4name2] = 0x10;      // slot 4 p-side goes to card 1, ch 0-6
     param0->fnSideMap[s4name2] = 0x32;      // slot 4 n-side goes to card 3, ch 2
     //----- Slot 5 -----
     ...
     param0->fpSideMap[s5name2] = 0x20;      // slot 5 p-side goes to card 2, ch 0-6 (WEIRD don't ask me)
     param0->fnSideMap[s5name2] = 0x33;      // slot 5 n-side goes to card 3, ch 3
     //----- Slot 6 -----
     ...
     param0->fpSideMap[s6name2] = 0x18;      // slot 6 p-side goes to card 1, ch 8-15 (ahhhh)
     param0->fnSideMap[s6name2] = 0x34;      // slot 6 n-side goes to card 3, ch 4
     //----- Slot 7 -----
     /* EMPTY SLOT!!!   TString s7name2 = "slot7_EMPTY";
     param0->fDetNameVec.push_back(s7name2);  // add detector to named list
     param0->fDetTypeMap[s7name2] = "SiPad";  // define detector type
     param0->fpSideMap[s7name2] = 0x130;      // slot 7 p-side goes to card 3, ch 0-6 (who tf wired this)
     param0->fnSideMap[s7name2] = 0x135;      // slot 7 n-side goes to card 3, ch 5
     */
     //----- Slot 8 -----
     ...
     param0->fpSideMap[s8name2] = 0x28;      // slot 8 p-side goes to card 2, ch 8-15
     param0->fnSideMap[s8name2] = 0x35;      // slot 8 n-side goes to card 3, ch 6
     //----- Slot 9 -----
     ...
     param0->fpSideMap[s9name2] = 0x128;      // slot 8 p-side goes to card 3, ch 8-15
     param0->fnSideMap[s9name2] = 0x137;      // slot 9 n-side goes to card 3, ch 7
     */
     //----- Slot BP -----
     TString sBPname2 = "slotBP_Crys_GAGG";
     param0->fDetNameVec.push_back(sBPname2); // add detector to named list
     param0->fDetTypeMap[sBPname2] = "Crystal"; // define detector type
     // for Crystal, front should go to 0, back to 1
     param0->fCrystalMap[sBPname2][0] = 0x3E;  // BP pin1 goes to card 3, ch 12
     param0->fCrystalMap[sBPname2][1] = 0x3F;  // BP pin2 goes to card 3, ch 13
