...
void set_PLEIADESParam()
{
    ...
    param0->fDSSDPos[0] = 0x148;            // pin1 goes to card 4, ch 8
    param0->fDSSDPos[1] = 0x149;            // pin2 goes to card 4, ch 9
    param0->fDSSDPos[2] = 0x14A;            // pin6 goes to card 4, ch 10
    param0->fDSSDPos[3] = 0x14B;            // pin7 goes to card 4, ch 11
    //----- Slot 3 -----
    ...
    param0->fCrystalPos[0] = 0x14E;         // BP pin1 goes to card 4, ch 14
    param0->fCrystalPos[1] = 0x14F;         // BP pin2 goes to card 4, ch 15
