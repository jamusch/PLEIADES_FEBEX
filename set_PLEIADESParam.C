...
//    TString s2name = "slot2_DSSD_C161054";
    ...
    // Detector number 2 ---> kinpex 1
     ...
     param0->fpSideMap[s1name2] = 0x100;      // slot 1 p-side goes to card 0, ch 0-6
     param0->fnSideMap[s1name2] = 0x130;      // slot 1 n-side goes to card 3, ch 0
     //----- Slot 2 -----
     ...
     // for DSSD, make sure p-sides (ie L/R) go to pos 0/1 in fDSSDMap
     param0->fDSSDMap[s2name2][0] = 0x138;            // pin1 goes to card 3, ch 8
     param0->fDSSDMap[s2name2][1] = 0x139;            // pin2 goes to card 3, ch 9
     param0->fDSSDMap[s2name2][2] = 0x13A;            // pin6 goes to card 3, ch 10
     param0->fDSSDMap[s2name2][3] = 0x13B;            // pin7 goes to card 3, ch 11
     //----- Slot 3 -----
     ...
     param0->fpSideMap[s3name2] = 0x108;      // slot 3 p-side goes to card 0, ch 8-15
     param0->fnSideMap[s3name2] = 0x131;      // slot 3 n-side goes to card 3, ch 1
     //----- Slot 4 -----
     ...
     param0->fpSideMap[s4name2] = 0x110;      // slot 4 p-side goes to card 1, ch 0-6
     param0->fnSideMap[s4name2] = 0x132;      // slot 4 n-side goes to card 3, ch 2
     //----- Slot 5 -----
     ...
     param0->fpSideMap[s5name2] = 0x120;      // slot 5 p-side goes to card 2, ch 0-6 (WEIRD don't ask me)
     param0->fnSideMap[s5name2] = 0x133;      // slot 5 n-side goes to card 3, ch 3
     //----- Slot 6 -----
     ...
     param0->fpSideMap[s6name2] = 0x118;      // slot 6 p-side goes to card 1, ch 8-15 (ahhhh)
     param0->fnSideMap[s6name2] = 0x134;      // slot 6 n-side goes to card 3, ch 4
     //----- Slot 7 -----
     ...
     */
     ...
     param0->fpSideMap[s8name2] = 0x128;      // slot 8 p-side goes to card 2, ch 8-15
     param0->fnSideMap[s8name2] = 0x135;      // slot 8 n-side goes to card 3, ch 6
     //----- Slot 9 -----
