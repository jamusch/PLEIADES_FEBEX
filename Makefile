...
EXAMP1STEP_LINKDEF     = $(EXAMP1STEP_DIR)/PLEIADESLinkDef.$(HedSuf)
#EXAMP1STEP_LIBNAME     = $(GO4_USERLIBNAME)
EXAMP1STEP_LIBNAME     = libMyGo4UserAnalysis

## must be similar for every module

EXAMP1STEP_DICT        = $(EXAMP1STEP_DIR)/$(DICT_PREFIX)PLEIADES
...
$(EXAMP1STEP_O) $(EXAMP1STEP_DEP) $(EXAMP1STEP_DO) $(EXAMP1STEP_DDEP)  : INCLUDES += -I$(ELDERINCPATH)
$(EXAMP1STEP_LIB): INCLUDES += -I$(ELDERINCPATH)
$(EXAMP1STEP_LIB): LDRPATHS += $(ELDERLIBPATH)
$(EXAMP1STEP_LIB): LIBS_FULLSET += -L$(ELDERLIBPATH) -lGo4UserAnalysis
